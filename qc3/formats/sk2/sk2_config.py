...
class SK2_Config(XmlConfigParser):
  ...
  # --- PAGE PROPERTIES
  page_format = "A4"
  page_orientation = qc3const.PORTRAIT
  ...
  grid_layer_geometry = [0.0, 0.0, qc3const.mm_to_pt, qc3const.mm_to_pt]
  ...
  default_stroke_width = 0.1 * qc3const.mm_to_pt
  ...
  default_text_fill = [sk2const.FILL_EVENODD, sk2const.FILL_SOLID, sk2const.CMYK_BLACK]
